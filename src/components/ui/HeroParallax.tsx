...
export const HeroParallax = ({
    ...
    return (
        <div
            ref={ref}
            className="h-[250vh] py-20 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-[#0B1120]"
        >
            <Header />
            <motion.div
                style={{
...
export const Header = () => {
    return (
        <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
            <h1 className="text-5xl md:text-8xl font-bold dark:text-white text-white">
                {HERO_CONTENT.title}
            </h1>
            <p className="max-w-2xl text-base md:text-2xl mt-8 dark:text-neutral-200 text-neutral-200">
